  ...
  return (
    <div className="blog-page max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12">
      ...
      <p className="text-body-lg font-body-lg text-on-surface-variant max-w-3xl mx-auto text-center mb-16">
        Категорията - Какво е SEO? предоставя подробна информация за оптимизацията за търсачки (SEO) – процес, който помага на уебсайтовете да се класират по-високо в резултатите на търсачките като Google. Тук ще откриете ключови понятия, основни техники и стратегии, които подобряват видимостта на вашия сайт, увеличават органичния трафик и водят до по-добро онлайн присъствие.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
        {posts?.map((post: any) => (
          <article key={post.slug} className="glass-card flex flex-col group hover:border-primary-container transition-all duration-300 p-4 inner-glow">
            ...
            <Link target="_blank" rel="nofollow" href={`/blog/${post.slug}`} className="w-full mt-auto">
